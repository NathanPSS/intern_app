                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                      MenuButton(icon: Image.asset("assets/imgs/group.png",width: 44,height: 44),nextScreenFunction: () {
                        Provider.of<NavigationProvider>(context, listen: false)
                            .navigateToScreen('users');
                      }),
                      MenuButton(icon: Image.asset("assets/imgs/report.png",width: 44,height: 44),nextScreenFunction: () {
                        Provider.of<NavigationProvider>(context, listen: false)
                            .navigateToScreen('registry');
                      }),
                      MenuButton(icon: Image.asset("assets/imgs/pie-chart.png",width: 44,height: 44),nextScreenFunction: () {
                        Provider.of<NavigationProvider>(context, listen: false)
                            .navigateToScreen('sectors');
                      }),
                    ],),
                  )
                ],
