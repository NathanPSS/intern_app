...
class DesktopDataTable extends StatefulWidget {
  ...
  final Function(TableRecord)? onRowTap;
  final Function(TableRecord)? onRowDoubleTap;
...
class _DesktopDataTableState extends State<DesktopDataTable> {
  ...
  List<TableRecord> _filteredRecords = [];
  ...
  void _showDetailsDialog(TableRecord record) {
    showDialog(
      context: context,
